...
const ESTADO_SELECTED_CLASS: Record<EstadoProveedor, string> = {
  activa: "border-green-500 bg-green-50 text-green-700",
  trial: "border-blue-500 bg-blue-50 text-blue-700",
  suspendida: "border-slate-400 bg-slate-100 text-slate-600",
};
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/40 backdrop-blur-sm">
      <div
        role="dialog"
        aria-modal="true"
        className="flex h-full w-full max-w-xl flex-col bg-white shadow-2xl animate-in slide-in-from-right"
      >
        {/* Cabecera */}
