...
// memoria (tokenStore) y no hay getter expuesto por useAuth(), así que se
// lee directo de ahí. autoConnect en false: quien llama decide cuándo
// conectar (por ejemplo, después de que termine la carga inicial por REST).
